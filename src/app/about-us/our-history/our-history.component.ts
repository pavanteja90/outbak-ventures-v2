...
export class OurHistoryComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta, private title: Title) {
        ...
        this.title.setTitle('Who We Are');
        this.meta.updateTag({ name: 'description', content: 'Outbak Ventures was established in 2017 to focus on providing business and management consultant for small companies and entrepreneurs in Australia.' });
        this.meta.updateTag({ name: 'keywords', content: 'about, about outbak, about outbak ventures, who we are, history, outbak ventures' });
    }
