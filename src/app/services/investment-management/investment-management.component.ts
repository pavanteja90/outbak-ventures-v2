...
export class InvestmentManagementComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta) {
        ...
        this.meta.addTags([
            { name: 'description', content: 'Capital optimisation and management to maximise your returns.' },
            { name: 'title', content: 'Investment Management | Services' },
            { name: 'author', content: 'outbakventures' },
            { name: 'keywords', content: 'investment, investors, management, outbak, ventures' }
        ]);
    }
