...
export class EngineeringSolutionsComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta) {
        ...
        this.meta.addTags([
            { name: 'description', content: 'Modern solutions for all modern problems.' },
            { name: 'title', content: 'Tech Solutions | Services' },
            { name: 'author', content: 'outbakventures' },
            { name: 'keywords', content: 'tech, technical, technological, engineering, solutions, outbak, ventures' }
        ]);
    }
