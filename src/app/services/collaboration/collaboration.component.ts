...
export class CollaborationComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta, private title: Title) {
        ...
        this.title.setTitle('Collaboration | Services');
        this.meta.updateTag({ name: 'description', content: 'Building relationships based on trust and equitable outcomes.' });
        this.meta.updateTag({ name: 'keywords', content: 'collaboration, partners, outbak ventures' });
    }
