...
export class InternationalServicesComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta, private title: Title) {
        ...
        this.title.setTitle('International Services | Services');
        this.meta.updateTag({ name: 'description', content: 'Facilitating a world without borders.' });
        this.meta.updateTag({ name: 'keywords', content: 'international, world, wide, services, outbak, ventures' });
    }
