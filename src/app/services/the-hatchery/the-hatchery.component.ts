...
@Component({
  selector: 'app-the-hatchery',
  templateUrl: './the-hatchery.component.html',
  styleUrls: ['./the-hatchery.component.css']
})
export class TheHatcheryComponent implements OnInit {
    ...
    ngOnInit() {
        this.googleAnalytics.emitEvent('PageView', 'The Hatchery');
    }
