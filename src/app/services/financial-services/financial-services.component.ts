...
export class FinancialServicesComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta, private title: Title) {
        ...
        this.title.setTitle('Financial Services | Services');
        this.meta.updateTag({ name: 'description', content: 'The right partner for all your financial and transactional requirements.' });
        this.meta.updateTag({ name: 'keywords', content: 'financial, money, economical, services, outbak, ventures' });
    }
