...
export class BusinessConsultingComponent implements OnInit {
    ...
    constructor(private router: Router, private googleAnalytics: GoogleAnalyticsService, private meta: Meta) {
        ...
        this.meta.addTags([
            { name: 'description', content: 'Strategic and personalised solution for all your business needs.' },
            { name: 'title', content: 'Business Consulting | Services' },
            { name: 'author', content: 'outbakventures' },
            { name: 'keywords', content: 'business, consulting, entrepreneurs, outbak, ventures' }
        ]);
    }
